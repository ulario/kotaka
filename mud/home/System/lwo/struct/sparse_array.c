...
private mixed **fetch_list(int values)
{
	mixed **list;
	int level;
	int bit;
	...
	build_list(data[0 .. 0xff], 0, list, values);
	build_list(data[0x100 .. 0xffff], 1, list, values);
	build_list(data[0x10000 .. 0xffffff], 2, list, values);
	build_list(data[0x1000000 .. 0xffffffff], 3, list, values);
